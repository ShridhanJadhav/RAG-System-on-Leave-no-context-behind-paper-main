...
with open(r'C:\Users\abdul\Desktop\Sardar\RAG_System\google_api.txt', 'r') as f:
...
def main():
    ...
    pdf_path = r"C:\Users\abdul\Desktop\Sardar\RAG_System\2404.07143.pdf"  # Replace with your PDF path
